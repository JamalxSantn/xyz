...
async def menu(ctx):
    ...
    if is_admin:
        ...
        embed.add_field(name="Key erstellen", value="> Erstelle einen neuen Key", inline=False)
        embed.add_field(name="Key einlösen", value="> Löse einen Key ein", inline=False)
        embed.add_field(name="Key prüfen", value="> Prüfe einen Key", inline=False)
        embed.add_field(name="Key löschen", value="> Lösche einen Key", inline=False)
        embed.add_field(name="Zeit hinzufügen", value="> Füge Zeit zu einem Key hinzu", inline=False)
        embed.add_field(name="Alle Keys", value="> Zeige alle Keys", inline=False)
        embed.add_field(name="HWID Reset", value="> Setzt HWID zurück", inline=False)
        embed.add_field(name="Neustarten", value="> Bot neu starten", inline=False)
        embed.add_field(name="Unlock Channel", value="> Entsperrt Channel", inline=False)
        embed.set_footer(text="F I STEINKE C++ MEISTER")
    ...
    try:
        ...
        if guild:
            ...
            if channel:
                ...
                key_embed.add_field(name="Erstellen", value="> Erstelle einen neuen Key", inline=False)
                key_embed.add_field(name="Prüfen", value="> Prüfe einen Key", inline=False)
                key_embed.add_field(name="Löschen", value="> Lösche einen Key", inline=False)
                key_embed.add_field(name="Zeit+", value="> Füge Zeit hinzu", inline=False)
                key_embed.add_field(name="Keys", value="> Zeige alle Keys", inline=False)
                key_embed.add_field(name="HWID", value="> Setzt HWID zurück", inline=False)
                key_embed.add_field(name="Restart", value="> Bot neu starten", inline=False)
                key_embed.add_field(name="Unlock", value="> Entsperrt Channel", inline=False)
